...
public class Menu extends JPanel{
	...
	public Menu(){  
		...
		//third link
		menu = new JMenu("G�n�rateur de power point");
		...
		//six link 
		menu = new JMenu("Informations M�decins");
		l1= new JMenuItem("Ajouter un m�decin");
		l2 = new JMenuItem("Consultation de la liste des m�decins");
